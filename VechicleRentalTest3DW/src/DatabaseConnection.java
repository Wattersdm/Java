...
public class DatabaseConnection
{
		...
		public static void main(String[] args) {
	        ...
	        try {
	    			...
	    			{	
	    				...
	    				// Pass in the table, primary key, and column
		 ...
		 */
		public static boolean LoadListFromDatabase( String strTable, String strPrimaryKeyColumn, String strNameColumn1, String strNameColumn2, String strNameColumn3, String strNameColumn4 ) {
			...
			try
			{
				...
				strSelect = "SELECT " + strPrimaryKeyColumn + ", " + strNameColumn1 + "," +  strNameColumn2 + "," +  strNameColumn3 + "," +  strNameColumn4
							+ " FROM " + strTable
				...
				while( rstTSource.next( ) == true )
				{
					...
					strName1 = rstTSource.getString( 2 );
					strName2 = rstTSource.getString( 3 );
					strName3 = rstTSource.getString( 4 );
					strName4 = rstTSource.getString( 5 );
					
					
					
					// Print the list
					System.out.println("Table is: " + strTable + " Primary key: " + intID + " Type: " + strName1 + " Make: " + strName2 + " Model: " +strName3 + " Year: " + strName4);
				}
				// Clean up
				rstTSource.close( );
				sqlCommand.close( );
		...
		public static boolean OpenDatabaseConnectionSQLServer( )
		{
			...
			try
			{
				...
				sdsTeamsAndPlayers.setDatabaseName( "JavaVehicle1" );
